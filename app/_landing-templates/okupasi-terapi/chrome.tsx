// Navbar & footer bersama template Okupasi Terapi (dipakai landing & halaman riwayat).
// Server component murni (tanpa state) → ringan & cacheable. Tema indigo/violet.
import Link from "next/link";
import { Puzzle, MapPin, Phone, Mail, AtSign, Clock } from "lucide-react";
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="mt-3 text-sm leading-relaxed text-gray-500">
            {clinic.description || "Layanan okupasi terapi untuk mendukung kemandirian dan tumbuh kembang optimal."}
          </p>
        </div>
